"""
Django settings for quiet_dust_3 project.
...
ROOT_URLCONF = 'quiet_dust_3.urls'
...
WSGI_APPLICATION = 'quiet_dust_3.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Quiet Dust Support <support@quiet-dust-3.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_dust_3 API",
    "DESCRIPTION": "API documentation for quiet_dust_3 App",
    "VERSION": "v1",
}
